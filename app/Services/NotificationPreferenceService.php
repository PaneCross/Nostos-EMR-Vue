    ...
    public static function catalog(): array
    {
        return [
            ...
            'designation.nursing_director.fall_risk_threshold' => [
                ...
                'description' => 'Alert when a participant\'s Morse fall scale crosses 45+ (high-risk threshold).',
                'status'      => self::STATUS_OPTIONAL,
                'default'     => false,
                'cms_ref'     => null,
                'wired'       => true,
            ...
            'designation.nursing_director.pressure_injury_staging' => [
                ...
                'description' => 'Alert when a wound progresses to a higher NPUAP stage (e.g., stage 2 → stage 3).',
                'status'      => self::STATUS_OPTIONAL,
                'default'     => false,
                'cms_ref'     => null,
                'wired'       => true,
            ...
            'designation.nursing_director.late_emar_pattern' => [
                ...
                'description' => 'Alert when the same nurse triggers ≥3 late medication doses within 7 days.',
                'status'      => self::STATUS_OPTIONAL,
                'default'     => false,
                'cms_ref'     => null,
                'wired'       => true,
            ...
            'designation.nursing_director.bcma_override_pattern' => [
                ...
                'description' => 'Alert when the same nurse triggers ≥3 barcode-medication-administration overrides within 7 days.',
                'status'      => self::STATUS_OPTIONAL,
                'default'     => false,
                'cms_ref'     => null,
                'wired'       => true,
            ...
            'designation.nursing_director.critical_value_unacked' => [
                ...
                'description' => 'Escalation alert when a critical lab value has not been acknowledged within policy hours.',
                'status'      => self::STATUS_OPTIONAL,
                'default'     => false,
                'cms_ref'     => null,
                'wired'       => true,
            ...
            'designation.pharmacy_director.controlled_substance_pattern' => [
                ...
                'description' => 'Alert when a single prescriber issues ≥5 controlled-substance prescriptions in 14 days.',
                'status'      => self::STATUS_OPTIONAL,
                'default'     => false,
                'cms_ref'     => null,
                'wired'       => true,
            ...
            'designation.pharmacy_director.bcma_override_review' => [
                ...
                'description' => 'Pharmacy review alert when a BCMA override involves a Schedule II/III controlled substance.',
                'status'      => self::STATUS_OPTIONAL,
                'default'     => false,
                'cms_ref'     => null,
                'wired'       => true,
            ...
            'designation.pharmacy_director.prior_auth_queue_oversight' => [
                ...
                'description' => 'Daily digest of prior-auth requests pending more than 3 days.',
                'status'      => self::STATUS_OPTIONAL,
                'default'     => false,
                'cms_ref'     => null,
                'wired'       => true,
            ...
            'designation.social_work_supervisor.sdoh_critical' => [
                ...
                'description' => 'Alert when housing instability or food insecurity is flagged high-severity on intake.',
                'status'      => self::STATUS_OPTIONAL,
                'default'     => false,
                'cms_ref'     => null,
                'wired'       => true,
            ...
            'designation.social_work_supervisor.bereavement_followup_missed' => [
                ...
                'description' => 'Alert when a bereavement family-contact follow-up has not been made within 14 days.',
                'status'      => self::STATUS_OPTIONAL,
                'default'     => false,
                'cms_ref'     => null,
                'wired'       => true,
            ...
            'designation.social_work_supervisor.adv_directive_missing_at_admit' => [
                ...
                'description' => 'Alert when a participant has been enrolled 30+ days with no DPOA or advance directive on file.',
                'status'      => self::STATUS_OPTIONAL,
                'default'     => false,
                'cms_ref'     => null,
                'wired'       => true,
            ...
            'designation.program_director.cms_reportable_grievance' => [
                ...
                'description' => 'Additional copy on grievance escalations flagged cms_reportable=true.',
                'status'      => self::STATUS_OPTIONAL,
                'default'     => false,
                'cms_ref'     => null,
                'wired'       => true,
            ...
            'workflow.appointment_no_show.notify_pcp' => [
                ...
                'description' => 'When a participant misses an appointment, alert their assigned PCP (in addition to the scheduling dept).',
                'status'      => self::STATUS_OPTIONAL,
                'default'     => false,
                'cms_ref'     => null,
                'wired'       => true,
