...
<head>
    ...
    <title>Your NostosEMR Portal Sign-In Code</title>
    <style>
    ...
    <div class="container">
        ...
        <div class="body">
            ...
            <p style="color:#475569;font-size:15px;">
                Use the code below to sign in to your participant portal. This code expires in
            ...
            <p style="color:#475569;font-size:14px;">
                Your portal contains protected health information. Unauthorized access is
