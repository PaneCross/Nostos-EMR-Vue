    ...
    <AppShell>
        ...
        <div class="px-6 py-5">
            ...
            <div class="flex flex-wrap items-center gap-2 mb-5">
                <span
                    class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-red-100 dark:bg-red-900/60 text-red-800 dark:text-red-300"
                >
                ...
                >
                    ...
                    <tbody class="divide-y divide-gray-100 dark:divide-slate-700">
                        ...
                        >
                            ...
                            <td class="px-4 py-3">
                                <span
                                    class="inline-flex px-2 py-0.5 rounded-full text-xs font-medium bg-gray-100 dark:bg-slate-700 text-gray-600 dark:text-slate-300"
                                >
