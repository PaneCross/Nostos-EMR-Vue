...
<template>
    ...
    <div
        class="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-blue-950 flex items-center justify-center p-4"
    >
        <div class="w-full max-w-md">
            ...
            <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-2xl overflow-hidden">
                ...
                <div class="bg-slate-900 px-8 py-8 text-center">
                    <div
                        class="inline-flex items-center justify-center w-14 h-14 bg-blue-600 rounded-xl mb-4"
                    >
                        <svg
                    ...
                    <template v-if="step === 'email'">
                        ...
                        <div class="relative my-6">
                            ...
                            <div class="relative flex justify-center">
                                <span class="bg-white dark:bg-slate-800 px-3 text-xs text-slate-400"
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            ...
                            >
                                ...
                                >
                                    <path
                                        d="M0 0l6.25 12.75L0 24h4.5l3.75-7.5L12 24h4.5L6.75 0H0zm18 0l-4.5 9h4.5L24 0h-6z"
                                    />
                                </svg>
                                Yahoo
                            </a>
                ...
                <!-- HIPAA notice -->
                <div
                    class="bg-slate-50 dark:bg-slate-900 border-t border-slate-200 dark:border-slate-700 px-8 py-4"
                >
                    <p class="text-xs text-slate-400 text-center leading-relaxed">
                        This system contains protected health information (PHI). Unauthorized access
                        is prohibited and monitored. All access is logged for compliance purposes.
                    </p>
                </div>
            </div>
