...
function domainClass(domain: string): string {
    return (
        DOMAIN_COLORS[domain] ?? 'bg-slate-100 text-slate-700 dark:bg-slate-700 dark:text-slate-300'
    )
}
...
<template>
    <AppShell>
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500 dark:text-slate-400">
                        Quality Assurance and Performance Improvement — 42 CFR §460.136–§460.140
                    </p>
                </div>
                <button
                    v-if="isQaAdmin"
            ...
            >
                ...
                <div class="text-sm">
                    <span class="font-semibold">
                        {{
                            props.meets_minimum
                                ? 'Compliance Minimum Met'
                                : 'Below Compliance Minimum'
                        }}
                    </span>
                    — {{ props.active_count }} active project{{
                        props.active_count !== 1 ? 's' : ''
                    }}
            ...
            <div class="flex gap-4 overflow-x-auto pb-4">
                ...
                >
                    ...
                    >
                        ...
                        <span
                            class="text-xs px-1.5 py-0.5 rounded-full bg-gray-200 dark:bg-slate-700 text-gray-600 dark:text-slate-400 font-medium"
                        >
                    ...
                    <div class="p-3 space-y-3 min-h-32">
                        ...
                        >
                            ...
                            <h4
                                class="text-sm font-semibold text-gray-900 dark:text-slate-100 leading-snug"
                            >
                                {{ project.title }}
                            </h4>

                            <p
                                v-if="project.aim_statement"
        ...
        <Teleport to="body">
            ...
            >
                <div
                    class="bg-white dark:bg-slate-800 rounded-xl shadow-2xl w-full max-w-xl max-h-[80vh] overflow-y-auto"
                >
                    <div
                    ...
                    <div class="px-6 py-5 space-y-4">
                            ...
                            <div class="flex flex-wrap gap-2 mb-2">
                                <span
                                    :class="[
                                        ...
                                        domainClass(detailProject.domain),
                                    ]"
                                >
                                    {{
                                ...
                                <span
                                    :class="[
                                        'px-2 py-0.5 rounded-full text-xs font-medium',
                                        STATUS_BADGE[detailProject.status] ??
                        ...
                        <div>
                            <p
                                class="text-xs font-semibold text-gray-500 dark:text-slate-400 uppercase mb-1"
                            >
                                Aim Statement
                            </p>
                            <p class="text-sm text-gray-700 dark:text-slate-300">
                                {{ detailProject.aim_statement || '-' }}
                            </p>
                        </div>
                        ...
                        <div
                            v-if="isQaAdmin"
                            class="pt-2 border-t border-gray-200 dark:border-slate-700 space-y-2"
                        >
                            <p
                                class="text-xs font-semibold text-gray-500 dark:text-slate-400 uppercase"
                            >
                                Actions
                            </p>
                            <div class="flex flex-wrap gap-2">
                                ...
                                <button
                                    v-if="
                                        ...
                                        detailProject.status !== 'suspended'
                                    "
                                    :disabled="actionLoading"
        ...
        <Teleport to="body">
            ...
            >
                <div
                    class="bg-white dark:bg-slate-800 rounded-xl shadow-2xl w-full max-w-lg max-h-[85vh] overflow-y-auto"
                >
                    <div
                        class="flex items-center justify-between px-6 py-4 border-b border-gray-200 dark:border-slate-700"
                    >
                    ...
                    <form class="px-6 py-5 space-y-4" @submit.prevent="submitForm()">
                        ...
                        <div>
                            ...
                            >
                                ...
                                <option
                                    v-for="(label, key) in props.domains"
                                    :key="key"
                                    :value="key"
                                >
                                    {{ label }}
                        ...
                        <div>
                            ...
                            ></textarea>
                            <p
                                v-if="formErrors.aim_statement"
                                class="mt-1 text-xs text-red-600 dark:text-red-400"
                            >
                                {{ formErrors.aim_statement }}
                            </p>
                        </div>
