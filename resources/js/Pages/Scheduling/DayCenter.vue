    ...
    <div class="px-6 py-6 space-y-5">
      ...
      <div class="flex items-start justify-between">
        ...
        <div class="flex items-center gap-2">
          <label class="text-sm text-gray-600 dark:text-slate-400 font-medium">Date:</label>
          <input
            type="date"
            :value="date"
      ...
      <div class="border border-gray-200 dark:border-slate-700 rounded-xl overflow-hidden bg-white dark:bg-slate-800 shadow-sm">
        <table class="w-full text-sm">
          <thead class="bg-gray-50 dark:bg-slate-700/50">
            <tr>
              <th
                v-for="h in ['Participant', 'MRN', 'Check-In', 'Check-Out', 'Status', ...(props.canManage ? ['Actions'] : [])]"
                :key="h"
            ...
            >
              ...
              <td class="px-4 py-3">
                <span
                  :class="[
                    ...
                    STATUS_COLORS[record.status] ?? 'bg-gray-100 dark:bg-slate-700 text-gray-700 dark:text-slate-300',
                  ]"
                >
              ...
              <td v-if="props.canManage" class="px-4 py-3">
                <div class="flex gap-2">
                  ...
                  <button
                    v-if="record.status !== 'absent' && record.status !== 'excused'"
      ...
      <p class="text-xs text-gray-400 dark:text-slate-500">
        Showing participants with attendance recorded for {{ formatDateLong(date) }}.
    ...
    >
      ...
      >
        ...
        <div class="px-6 pt-5 pb-4 border-b border-gray-100 dark:border-slate-700 flex items-center justify-between">
          <h2 class="text-base font-semibold text-gray-900 dark:text-slate-100">Mark Absence</h2>
          <button
