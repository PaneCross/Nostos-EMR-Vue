...
const TAB_COMPONENTS: Record<string, unknown> = {
  overview: OverviewTab, chart: ChartTab, allergies: AllergiesTab,
  problems: ProblemsTab, vitals: VitalsTab, flags: FlagsTab,
  medications: MedicationsTab, emar: EmarTab, care_plan: CarePlanTab,
  assessments: AssessmentsTab, sdoh: SdohTab, immunizations: ImmunizationsTab,
  procedures: ProceduresTab, lab_results: LabResultsTab, wounds: WoundsTab,
  contacts: ContactsTab, addresses: AddressesTab, insurance: InsuranceTab,
  transfers: TransfersTab, documents: DocumentsTab,
}
...
<template>
  <AppShell>
    ...
    <div class="bg-white dark:bg-slate-800 border-b border-gray-200 dark:border-slate-700 px-4 overflow-x-auto">
      <div class="flex items-end gap-0 min-w-max" role="tablist">
        <!-- Clinical label -->
        <span class="text-xs font-bold text-blue-500 uppercase tracking-wider px-2 py-2 mr-1 self-center">Clinical</span>
        <button
        ...
        <span class="text-xs font-bold text-slate-400 uppercase tracking-wider px-3 py-2 mx-1 self-center border-l border-gray-200 dark:border-slate-700">Admin</span>
        <button
