...
// Tabs/OrdersTab.vue
// CPOE order entry per 42 CFR 460.90 provider order requirements.
// Prescriber departments only; tracks order lifecycle from draft to completed.
...
async function loadData() {
    loading.value = true
    try {
        const r = await axios.get(`/participants/${props.participantId}/orders`)
