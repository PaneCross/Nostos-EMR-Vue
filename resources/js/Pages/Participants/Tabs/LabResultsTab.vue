...
// Tabs/LabResultsTab.vue
// Lab result viewer with HL7 component parsing and critical value flagging.
// Critical results are highlighted in red. Links to FHIR DiagnosticReport endpoint.
...
async function loadData() {
    loading.value = true
    try {
        const r = await axios.get(`/participants/${props.participantId}/lab-results`)
