...
// Tabs/AdlTab.vue
// Activities of Daily Living functional status history.
// Shows current ADL levels across 10 categories and level of assistance needed.
...
async function loadData() {
    loading.value = true
    try {
        const r = await axios.get(`/participants/${props.participantId}/adl`)
