            ...
            <table class="text-sm w-full">
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-slate-700">
                    ...
                    >
                        ...
                        <td class="px-4 py-2 text-xs font-mono text-slate-600 dark:text-slate-300">
                            {{ entry.action }}
                        </td>
                        <td class="px-4 py-2 text-xs text-gray-700 dark:text-slate-300 max-w-md">
                            {{ entry.description ?? '-' }}
                        </td>
