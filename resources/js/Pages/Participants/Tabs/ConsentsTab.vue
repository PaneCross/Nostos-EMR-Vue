...
// Tabs/ConsentsTab.vue
// NPP consent records and participant care designations.
// Tracks HIPAA consent, advance directive acknowledgments, and care plan consents.
...
async function loadData() {
    loading.value = true
    try {
        const r = await axios.get(`/participants/${props.participantId}/consents`)
