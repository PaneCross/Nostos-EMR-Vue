...
// Tabs/ProceduresTab.vue
// Clinical procedures and treatments performed on the participant.
// Includes procedure code, description, performing provider, and date.
...
async function loadData() {
    loading.value = true
    try {
        const r = await axios.get(`/participants/${props.participantId}/procedures`)
