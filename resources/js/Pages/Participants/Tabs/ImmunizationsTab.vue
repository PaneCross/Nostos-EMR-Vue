...
// Tabs/ImmunizationsTab.vue
// Immunization records per 42 CFR 460 PACE requirements.
// Tracks flu, pneumo, COVID, and other vaccines with administration dates and lot numbers.
...
async function loadData() {
    loading.value = true
    try {
        const r = await axios.get(`/participants/${props.participantId}/immunizations`)
