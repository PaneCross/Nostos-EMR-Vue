...
// Shows MAR entries with administration status (given, late, refused, omitted).
...
async function loadData() {
    loading.value = true
    try {
        const r = await axios.get(`/participants/${props.participantId}/emar`)
