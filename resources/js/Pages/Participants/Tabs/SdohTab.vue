...
// Tabs/SdohTab.vue
// Social Determinants of Health (SDOH) screening results.
// Tracks housing stability, food security, transportation, and social isolation scores.
...
async function loadData() {
    loading.value = true
    try {
        const r = await axios.get(`/participants/${props.participantId}/social-determinants`)
