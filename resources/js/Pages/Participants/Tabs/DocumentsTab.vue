...
// Tabs/DocumentsTab.vue
// Participant document store supporting PDF/JPEG/PNG/DOCX uploads.
// Category filter chips for consent, care_plan, lab_report, imaging, legal, etc.
...
async function loadData() {
    loading.value = true
    try {
        const r = await axios.get(`/participants/${props.participantId}/documents`)
