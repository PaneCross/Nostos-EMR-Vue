...
// Tabs/MedReconTab.vue
// Medication reconciliation workflow (5-step process).
// Steps: start, prior meds, comparison, decisions, provider approval.
...
async function loadData() {
    loading.value = true
    try {
        const r = await axios.get(`/participants/${props.participantId}/med-reconciliation`)
