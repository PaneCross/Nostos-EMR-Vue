...
// Tabs/GrievancesTab.vue
// Grievance workflow per 42 CFR 460.120 participant rights requirements.
// Tracks complaint intake, investigation, resolution, and CMS regulatory reporting.
...
async function loadData() {
    loading.value = true
    try {
        const r = await axios.get(`/participants/${props.participantId}/grievances`)
