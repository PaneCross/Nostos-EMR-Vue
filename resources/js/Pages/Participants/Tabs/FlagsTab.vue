...
const FLAG_LABELS: Record<string, string> = {
    ...
    diet: 'Diet Restriction',
    transportation: 'Transport Flag',
    legal: 'Legal Hold',
}

const SEVERITY_COLORS: Record<string, string> = {
    critical:
        'bg-red-100 dark:bg-red-900/60 text-red-800 dark:text-red-300 border border-red-300 dark:border-red-700',
        ...
        >
            ...
            <div class="grid grid-cols-2 gap-3 mb-3">
                <div>
                    ...
                    >
                        <option v-for="(label, key) in FLAG_LABELS" :key="key" :value="key">
                            {{ label }}
                        </option>
                    </select>
                </div>
        ...
        <div v-else class="flex flex-wrap gap-2 items-start mb-6">
            <div
                ...
                :class="[
                    ...
                    SEVERITY_COLORS[flag.severity] ?? SEVERITY_COLORS.info,
                ]"
            >
