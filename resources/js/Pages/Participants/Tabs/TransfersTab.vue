...
// Tabs/TransfersTab.vue
// Multi-site participant transfer requests with status tracking.
// Tracks pending/approved/completed/cancelled transfers; 90-day prior-site read access window.
...
async function loadData() {
    loading.value = true
    try {
        const r = await axios.get(`/participants/${props.participantId}/transfers`)
