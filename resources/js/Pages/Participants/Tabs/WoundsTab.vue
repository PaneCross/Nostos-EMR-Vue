...
// Tabs/WoundsTab.vue
// Wound care records and assessment history.
// Tracks wound type, anatomical location, dimensions, and healing progress over time.
...
async function loadData() {
    loading.value = true
    try {
        const r = await axios.get(`/participants/${props.participantId}/wounds`)
