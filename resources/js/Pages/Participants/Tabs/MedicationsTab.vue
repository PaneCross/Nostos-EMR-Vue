...
// Tabs/MedicationsTab.vue
// Active medication list with prescriber, dose, frequency, and schedule.
// Includes DEA Schedule II/III tracking and drug interaction alerts.
...
async function loadData() {
    loading.value = true
    try {
        const r = await axios.get(`/participants/${props.participantId}/medications`)
