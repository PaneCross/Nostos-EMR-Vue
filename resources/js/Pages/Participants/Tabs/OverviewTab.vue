  ...
  <div id="facesheet-print" class="p-6 max-w-4xl">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <div class="bg-white dark:bg-slate-800 rounded-lg border border-gray-200 dark:border-slate-700 p-4 md:col-span-2">
        <h3 class="text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-3">Active Problem List</h3>
        <div v-if="activeProblems.length === 0" class="text-sm text-gray-400 dark:text-slate-500">No active problems on file</div>
