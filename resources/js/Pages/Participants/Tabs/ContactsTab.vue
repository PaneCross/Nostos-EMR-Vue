            ...
            >
                <div class="flex items-start justify-between mb-2">
                    ...
                    <div class="flex gap-1.5">
                        <span
                            v-if="c.is_emergency_contact"
                            class="text-xs px-1.5 py-0.5 rounded-full bg-red-100 dark:bg-red-900/60 text-red-700 dark:text-red-300"
                            >Emergency</span
                        >
                        <span
                            v-if="c.is_primary_caregiver"
                            class="text-xs px-1.5 py-0.5 rounded-full bg-green-100 dark:bg-green-900/60 text-green-700 dark:text-green-300"
                            >Caregiver</span
                        >
                    </div>
                </div>
                ...
                <div class="space-y-3">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <div>
                            ...
                            >
                                <option
                                    v-for="(label, key) in CONTACT_TYPE_LABELS"
                                    :key="key"
                                    :value="key"
                                >
                                    {{ label }}
                    ...
                    <div class="flex gap-4">
                        <label
                            class="flex items-center gap-2 text-sm text-gray-700 dark:text-slate-300 cursor-pointer"
                        >
                            <input
                        ...
                        >
                            <input
                                v-model="form.is_primary_caregiver"
                                type="checkbox"
                                class="rounded"
                            />
                            Primary Caregiver
