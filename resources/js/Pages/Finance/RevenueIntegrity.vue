        ...
        <div class="p-6 space-y-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                >
                    <p
                        ...
                        :class="kpiLabelClass(kpi.status)"
                    >
                        {{ kpi.label }}
                    </p>
                    <p class="text-2xl font-bold" :class="kpiValueClass(kpi.status)">
                        {{ kpi.value }}
                    </p>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4 space-y-1">
                    ...
                    <p class="text-2xl font-bold text-gray-900 dark:text-white">
                        {{ denial_kpis.denial_rate.toFixed(1) }}%
                    </p>
                </div>
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4 space-y-1">
                    <p
                    ...
                    <p class="text-2xl font-bold text-gray-900 dark:text-white">
                        ${{ denial_kpis.amount_at_risk.toLocaleString() }}
                    </p>
                </div>
            </div>
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            <td class="px-6 py-4 text-sm text-gray-600 dark:text-gray-300">
                                {{
                                    gap.estimated_impact != null
                                        ? '$' + Number(gap.estimated_impact).toLocaleString()
                                        : '-'
                                }}
                            </td>
                            <td
                                class="px-6 py-4 text-sm text-gray-600 dark:text-gray-300 capitalize"
                            >
                                {{ gap.status ?? '-' }}
                            </td>
                        </tr>
