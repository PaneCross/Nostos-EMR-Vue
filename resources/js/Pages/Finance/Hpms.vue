                ...
                <div class="space-y-4">
                    <div>
                        ...
                        >
                            ...
                            <option v-for="(label, key) in submissionTypes" :key="key" :value="key">
                                {{ label }}
                            </option>
                        </select>
                    </div>
...
const isEnrollmentType = computed(() => ['enrollment', 'disenrollment'].includes(form.value.type))

const isQualityType = computed(() => form.value.type === 'quality_data')
