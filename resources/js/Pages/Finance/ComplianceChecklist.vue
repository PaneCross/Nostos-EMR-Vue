        ...
        <div class="p-6 space-y-6">
            ...
            <div :class="bannerClass" class="rounded-lg p-4 flex items-center gap-3">
                ...
                <div>
                    ...
                    <p v-if="lastChecked" class="text-xs mt-0.5 opacity-75">
                    ...
                    <ul class="divide-y divide-gray-100 dark:divide-gray-700">
                        ...
                        >
                            <span
                                ...
                                class="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-medium flex-shrink-0 mt-0.5"
                            >
                                <CheckCircleIcon
                            ...
                            <span
                                v-if="check.checked_at"
                                class="text-xs text-gray-400 flex-shrink-0"
                                >{{ check.checked_at }}</span
                            >
                        </li>
                    </ul>
                </div>
            ...
            <div
                v-else
                class="flex flex-col items-center justify-center py-16 text-gray-500 dark:text-gray-400 bg-white dark:bg-gray-800 rounded-lg shadow"
            >
...
const bannerClass = computed(() => {
    if (props.overallStatus === 'pass')
        return 'bg-green-50 border border-green-200 text-green-800 dark:bg-green-950 dark:border-green-800 dark:text-green-200'
    if (props.overallStatus === 'warn')
        return 'bg-amber-50 border border-amber-200 text-amber-800 dark:bg-amber-950 dark:border-amber-800 dark:text-amber-200'
