    ...
    <div class="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-950 px-6">
        <div class="text-center max-w-md w-full">
            ...
            <div class="flex justify-center mb-6">
                <span class="inline-flex items-center justify-center w-20 h-20 rounded-full bg-blue-100 dark:bg-blue-950/60">
                    <ClockIcon class="w-10 h-10 text-blue-500 dark:text-blue-400" aria-hidden="true" />
                </span>
            </div>
            ...
            <p class="text-sm text-slate-500 dark:text-slate-400 mb-8">
                The service is temporarily unavailable. We may be performing maintenance.
