    ...
    <div class="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-950 px-6">
        <div class="text-center max-w-md w-full">
            ...
            <div class="flex justify-center mb-6">
                <span
                    class="inline-flex items-center justify-center w-20 h-20 rounded-full bg-red-100 dark:bg-red-950/60"
                >
            ...
            <!-- Error code -->
            <p
                class="text-sm font-semibold text-red-500 dark:text-red-400 uppercase tracking-widest mb-2"
            >
                403 — Access Denied
            </p>
