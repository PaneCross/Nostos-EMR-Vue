        ...
        <div class="max-w-4xl mx-auto px-6 py-8">
            ...
            <div class="flex items-center gap-3 mb-8">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500 dark:text-slate-400">
                        Tenant configuration and integration status
                    </p>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2">
                    ...
                    >
                        ...
                        <form class="space-y-4" @submit.prevent="submit">
                            <div>
                                ...
                                />
                                <p
                                    v-if="form.errors.pace_contract"
                                    class="mt-1 text-xs text-red-600 dark:text-red-400"
                                >
                                    {{ form.errors.pace_contract }}
                                </p>
                            </div>
                            <div>
                                <label
                            ...
                            <div>
                                ...
                                >
                                    <option v-for="tz in US_TIMEZONES" :key="tz" :value="tz">
                                        {{ tz }}
                                    </option>
                                </select>
                            </div>
                            <div>
                                ...
                                <p class="mt-1 text-xs text-gray-500 dark:text-slate-400">
                                    Set via SESSION_LIFETIME in server .env
                                </p>
                            </div>
                    ...
                    <div
                        class="mt-6 bg-white dark:bg-slate-800 rounded-xl border border-gray-200 dark:border-slate-700 shadow-sm p-6"
                    >
                        ...
                        <div
                            v-if="props.medicaidConfigs.length === 0"
                        ...
                        <table v-else class="w-full text-sm">
                            <thead>
                                <tr>
                                    <th
                                        class="text-left py-2 font-medium text-gray-600 dark:text-slate-400"
                                    >
                                        State
                                    </th>
                                    <th
                            ...
                            <tbody class="divide-y divide-gray-100 dark:divide-slate-700">
                                <tr v-for="c in props.medicaidConfigs" :key="c.id">
                                    <td class="py-2 text-gray-900 dark:text-slate-100">
                                        {{ c.state_code }} - {{ c.state_name }}
                                    </td>
                ...
                <div>
                    ...
                    >
                        ...
                        <div class="space-y-3">
                            <div
                                v-for="(status, key) in props.integrationStatus"
                                :key="key"
                            ...
                            >
                                ...
                                <div class="flex items-center gap-1">
                                    <component
                                        :is="integrationIcon(status)"
                                        class="w-4 h-4"
                                        :class="integrationClass(status)"
                                    />
                                    <span
                        ...
                        <div class="mt-4">
                            <button
                                ...
                                @click="router.visit('/it-admin/integrations')"
                            >
