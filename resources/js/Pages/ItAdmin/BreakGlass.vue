...
const filtered = computed(() =>
    filter.value === 'unacknowledged'
        ? events.value.filter((e) => !e.is_acknowledged)
        : events.value,
)
    ...
    <AppShell>
        ...
        <div class="max-w-6xl mx-auto px-6 py-8">
            ...
            <div
                ...
                class="text-center py-16 text-gray-500 dark:text-slate-400"
            >
                    ...
                    <tbody class="divide-y divide-gray-100 dark:divide-slate-700">
                        ...
                        >
                            ...
                            <td class="px-4 py-3 max-w-xs">
                                <p class="text-gray-700 dark:text-slate-300 line-clamp-2">
                                    {{ event.justification }}
                                </p>
                            </td>
                            <td
