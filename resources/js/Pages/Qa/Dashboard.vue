...
const kpiCards = computed<KpiDef[]>(() => [
  { label: 'Open Incidents',          value: props.kpis.open_incidents,              sublabel: 'Require attention',     color: props.kpis.open_incidents > 0 ? 'red' : 'green',   alert: props.kpis.open_incidents > 0 },
  { label: 'Require RCA',             value: props.kpis.incidents_requiring_rca,     sublabel: 'Pending root cause',    color: props.kpis.incidents_requiring_rca > 0 ? 'amber' : 'green', alert: props.kpis.incidents_requiring_rca > 0 },
  { label: 'Overdue RCAs',            value: props.kpis.overdue_rcas,                sublabel: 'Past 30-day deadline',  color: props.kpis.overdue_rcas > 0 ? 'red' : 'green',     alert: props.kpis.overdue_rcas > 0 },
  { label: 'Unsigned Notes > 24h',    value: props.kpis.unsigned_notes_24h,          sublabel: 'Clinical documentation', color: props.kpis.unsigned_notes_24h > 0 ? 'amber' : 'green', alert: props.kpis.unsigned_notes_24h > 0 },
  { label: 'Overdue Assessments',     value: props.kpis.overdue_assessments,         sublabel: 'Past due date',         color: props.kpis.overdue_assessments > 0 ? 'amber' : 'green', alert: props.kpis.overdue_assessments > 0 },
  { label: 'Open Grievances',         value: props.kpis.open_grievances,             sublabel: 'Active grievance queue', color: props.kpis.open_grievances > 0 ? 'amber' : 'green', alert: props.kpis.open_grievances > 0 },
  { label: 'CMS Reportable',          value: props.kpis.cms_reportable_grievances,   sublabel: 'Grievances flagged',    color: props.kpis.cms_reportable_grievances > 0 ? 'red' : 'green', alert: props.kpis.cms_reportable_grievances > 0 },
  { label: 'Active QAPI Projects',    value: props.kpis.active_qapi_projects,        sublabel: '42 CFR §460.140',       color: 'blue',   alert: false },
  { label: 'Care Plans Due Review',   value: props.kpis.care_plans_due_review,       sublabel: 'Within 30 days',        color: props.kpis.care_plans_due_review > 0 ? 'amber' : 'green', alert: props.kpis.care_plans_due_review > 0 },
  { label: 'Open Alerts',             value: props.kpis.open_alerts,                 sublabel: 'System alerts',         color: props.kpis.open_alerts > 5 ? 'amber' : 'slate',    alert: props.kpis.open_alerts > 5 },
  { label: 'Compliance Score',        value: props.kpis.compliance_score,            sublabel: 'Overall posture %',     color: props.kpis.compliance_score >= 90 ? 'green' : props.kpis.compliance_score >= 75 ? 'amber' : 'red', alert: props.kpis.compliance_score < 75 },
])
