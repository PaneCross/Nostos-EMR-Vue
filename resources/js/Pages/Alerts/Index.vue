    ...
    <AppShell>
        ...
        <div class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
            ...
            >
                <!-- Tab bar + filters -->
                <div
                    class="flex flex-wrap items-center justify-between gap-3 px-5 py-3 border-b border-gray-200 dark:border-slate-700"
                >
                    <!-- View tabs -->
                    <div class="flex">
                        <button
                            v-for="tab in [
                                ...
                                { key: 'dismissed' as ViewTab, label: 'Dismissed (30d)' },
                            ]"
                            :key="tab.key"
                            :class="[
                    ...
                    <div class="flex flex-wrap items-center gap-2">
                        <!-- Severity filter -->
                        <div
                            class="flex rounded-lg border border-gray-200 dark:border-slate-700 overflow-hidden text-xs"
                        >
                            <button
                                v-for="s in [
                                    'all',
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div class="flex-1 min-w-0">
                                <div class="flex flex-wrap items-center gap-2 mb-1">
                                    ...
                                    <!-- Alert type -->
                                    <span
                                        class="text-xs font-medium text-gray-600 dark:text-slate-400 uppercase tracking-wide"
                                    >
                                    ...
                                    <!-- Unread dot -->
                                    <span
                                        v-if="!alert.acknowledged_at && alert.is_active"
                                ...
                                <!-- Participant + time -->
                                <div
                                    class="flex flex-wrap items-center gap-3 mt-2 text-xs text-gray-500 dark:text-slate-400"
                                >
                                    <span v-if="alert.participant_name">
                                        Participant:
                                        <span
                                            class="font-medium text-gray-700 dark:text-slate-300"
                                            >{{ alert.participant_name }}</span
                                        >
                                    </span>
