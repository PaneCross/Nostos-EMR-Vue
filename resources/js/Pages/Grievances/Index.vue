...
const tabConfig = [
    ...
    {
        key: 'resolved' as TabKey,
        label: 'Resolved',
        countFn: () => props.resolvedGrievances.length,
    },
...
function onParticipantInput() {
    ...
    participantSearchTimeout.value = setTimeout(async () => {
        const res = await axios.get(
            `/participants/search?q=${encodeURIComponent(participantQuery.value)}`,
        )
        ...
        <div class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500 dark:text-slate-400">
                        42 CFR §460.118 — Grievance and Appeals Process
                    </p>
                </div>
                <button
            ...
            >
                ...
                <div
                    ...
                    class="py-14 text-center text-sm text-gray-500 dark:text-slate-400"
                >
                            ...
                            >
                                ...
                                >
                                    <div class="flex items-center gap-1">
                                        {{ g.reference_number }}
                                        <FlagIcon
                                            v-if="g.cms_reportable"
                                            class="w-3.5 h-3.5 text-red-500"
                                            title="CMS Reportable"
                                        />
                                    </div>
                                </td>
                                ...
                                <td class="px-4 py-3 text-gray-600 dark:text-slate-300">
                                    {{ props.categories[g.category] ?? g.category }}
                                </td>
                                <td class="px-4 py-3 text-gray-600 dark:text-slate-300">
                                    {{ g.filed_by_name }}
                                </td>
        ...
        <Teleport to="body">
            ...
            >
                ...
                >
                    ...
                    <form class="px-6 py-5 space-y-4" @submit.prevent="submitModal()">
                        <!-- Participant search -->
                        <div>
                            <label
                            ...
                            <div class="relative">
                                ...
                                >
                                    ...
                                    >
                                        {{ p.name }}
                                        <span
                                            class="text-gray-400 dark:text-slate-400 text-xs ml-1"
                                            >{{ p.mrn }}</span
                                        >
                                    </li>
                                </ul>
                            ...
                            <p
                                v-if="formErrors.participant_id"
                                class="mt-1 text-xs text-red-600 dark:text-red-400"
                            >
                                {{ formErrors.participant_id }}
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            />
                            <p
                                v-if="formErrors.filed_by_name"
                                class="mt-1 text-xs text-red-600 dark:text-red-400"
                            >
                                {{ formErrors.filed_by_name }}
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            >
                                ...
                                <option
                                    v-for="(label, key) in props.categories"
                                    :key="key"
                                    :value="key"
                                >
                                    {{ label }}
                        ...
                        <div>
                            ...
                            >
                                <option
                                    v-for="(label, key) in props.priorities"
                                    :key="key"
                                    :value="key"
                                >
                                    {{ label }}
                        ...
                        <div v-if="props.isQaAdmin" class="flex items-center gap-3">
                            ...
                            <label
                                for="cms_reportable"
                                class="text-sm font-medium text-gray-700 dark:text-slate-300 flex items-center gap-1"
                            >
