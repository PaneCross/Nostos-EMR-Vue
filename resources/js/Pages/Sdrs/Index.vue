...
const tabs = computed((): TabDef[] => [
    { key: 'my_dept', label: 'My Department', count: props.myDeptSdrs.length, visible: true },
    {
        ...
        count: props.assignedToMe.length,
        visible: true,
    },
    { key: 'overdue', label: 'Overdue', count: props.overdueSdrs.length, visible: true },
    {
        key: 'all',
        label: 'All SDRs',
        count: props.allSdrs?.data?.length ?? null,
        visible: props.userDept === 'qa_compliance',
    },
])
        ...
        <div class="px-6 py-6 space-y-5">
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-500 dark:text-slate-400 mt-0.5">
                        72-hour completion window. Requests are escalated automatically when
                        overdue.
                    </p>
                </div>
                <button
            ...
            >
                ...
                <div class="flex-1">
                    <p class="text-sm font-semibold text-red-800 dark:text-red-300">
                        {{ props.overdueSdrs.length }} SDR{{
                            props.overdueSdrs.length !== 1 ? 's' : ''
                        }}
            ...
            <div v-else class="grid grid-cols-1 xl:grid-cols-2 gap-3">
                ...
                >
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-xs text-gray-500 dark:text-slate-400 mt-0.5">
                                ...
                                <span class="text-gray-400 dark:text-slate-500">
                                    {{ deptLabel(sdr.requesting_department) }} &rarr;
                                    {{ deptLabel(sdr.assigned_department) }}
                                </span>
                            </p>
                        </div>
                    ...
                    <!-- Description snippet -->
                    <p class="text-xs text-gray-600 dark:text-slate-400 line-clamp-2">
                        {{ sdr.description }}
                    </p>
            ...
            >
                ...
                >
                    <h2 class="font-semibold text-gray-800 dark:text-slate-200">
                        Submit Service Delivery Request
                    </h2>
                    <button
                ...
                <div class="px-6 py-5 space-y-4">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <div>
                            ...
                            <select
                                ...
                                class="block w-full rounded-lg border border-gray-300 dark:border-slate-600 text-sm py-2 px-3 dark:bg-slate-700"
                            >
                                <option v-for="t in props.requestTypes" :key="t" :value="t">
                                    {{ TYPE_LABELS[t] ?? t }}
                                </option>
                            </select>
                        </div>
                    ...
                    <div>
                        ...
                        <p class="text-[10px] text-gray-400 dark:text-slate-500 mt-0.5">
                            This request will be due within 72 hours of submission (CMS
                            requirement).
                        </p>
                    </div>
                </div>
